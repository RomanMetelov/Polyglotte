...
import com.polyglotte.databinding.FragmentAlgorithmsBinding

class AlgorithmsFragment : Fragment() {

	private lateinit var viewModel: AlgorithmsViewModel
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		viewModel = ViewModelProvider(this).get(AlgorithmsViewModel::class.java)
		setupObservers()
	}
	...
	companion object {
		fun newInstance() = AlgorithmsFragment()
	}
}
